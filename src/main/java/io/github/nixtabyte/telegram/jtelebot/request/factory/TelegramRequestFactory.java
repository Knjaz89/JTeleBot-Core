...
public final class TelegramRequestFactory {
	 ...
	 * @throws JsonParsingException 
	 */
	public static TelegramRequest createSendPhotoRequest(final long chatId,final String photoId, final String caption, final Long replyToMessageId, final CustomReplyKeyboard customReplyKeyboard) throws   JsonParsingException{
		List <BasicNameValuePair>basicNameValuePair = new ArrayList<BasicNameValuePair>();
		basicNameValuePair.add(new BasicNameValuePair("chat_id",String.valueOf(chatId)));
	 ...
	 * @throws JsonParsingException 
	 */
	public static TelegramRequest createSendAudioRequest(final long chatId,final File inputFile, final Long replyToMessageId, final CustomReplyKeyboard customReplyKeyboard) throws   JsonParsingException{
		List <BasicNameValuePair>basicNameValuePair = new ArrayList<BasicNameValuePair>();
		basicNameValuePair.add(new BasicNameValuePair("chat_id",String.valueOf(chatId)));
		TelegramRequestFactory.addIfNotNull("reply_to_message_id",replyToMessageId,basicNameValuePair);
		TelegramRequestFactory.addIfNotNull("reply_markup",customReplyKeyboard,basicNameValuePair);
	 ...
	 * @throws JsonParsingException 
	 */
	public static TelegramRequest createSendAudioRequest(final long chatId,final String audioId, final Long replyToMessageId, final CustomReplyKeyboard customReplyKeyboard) throws   JsonParsingException{
		List <BasicNameValuePair>basicNameValuePair = new ArrayList<BasicNameValuePair>();
		basicNameValuePair.add(new BasicNameValuePair("chat_id",String.valueOf(chatId)));
	 ...
	 * @throws JsonParsingException 
	 */
	public static TelegramRequest createSendDocumentRequest(final long chatId,final File inputFile, final Long replyToMessageId, final CustomReplyKeyboard customReplyKeyboard) throws   JsonParsingException{
		List <BasicNameValuePair>basicNameValuePair = new ArrayList<BasicNameValuePair>();
		basicNameValuePair.add(new BasicNameValuePair("chat_id",String.valueOf(chatId)));
		TelegramRequestFactory.addIfNotNull("reply_to_message_id",replyToMessageId,basicNameValuePair);
		TelegramRequestFactory.addIfNotNull("reply_markup",customReplyKeyboard,basicNameValuePair);
	 ...
	 * @throws JsonParsingException 
	 */
	public static TelegramRequest createSendVideoRequest(final long chatId,final String videoId, final Long replyToMessageId, final CustomReplyKeyboard customReplyKeyboard) throws   JsonParsingException{
		List <BasicNameValuePair>basicNameValuePair = new ArrayList<BasicNameValuePair>();
		basicNameValuePair.add(new BasicNameValuePair("chat_id",String.valueOf(chatId)));
	 ...
	 * @throws JsonParsingException 
	 */
	public static TelegramRequest createSendLocationRequest(final long chatId,final double latitude,final double longitude, final Long replyToMessageId, final CustomReplyKeyboard customReplyKeyboard) throws   JsonParsingException{
		List <BasicNameValuePair>basicNameValuePair = new ArrayList<BasicNameValuePair>();
		basicNameValuePair.add(new BasicNameValuePair("chat_id",String.valueOf(chatId)));
